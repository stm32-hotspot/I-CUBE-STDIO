...
*			Replace -> LCD_I2C_HANDLER 
*					with your own I2C handler
*		For Anyother MCU:
*			Remove/Replace -> extern I2C_HandleTypeDef LCD_I2C_HANDLER;
...
extern I2C_HandleTypeDef LCD_I2C_HANDLER;
...
*					with your own I2C handler
*		For Anyother MCU:
*			Replace -> HAL_I2C_Master_Transmit(&LCD_I2C_HANDLER, (uint16_t)I2C_RGB_ADDR, (uint8_t*)data, 2, 1000);
...
static void LCD_setReg(unsigned char reg, unsigned char val)
{
  ...
  HAL_I2C_Master_Transmit(&LCD_I2C_HANDLER, (uint16_t)I2C_RGB_ADDR, (uint8_t*)data, 2, 1000);
}
...
*					with your own I2C handler
*		For Anyother MCU:
*			Replace -> HAL_I2C_Master_Transmit(&LCD_I2C_HANDLER, (uint16_t)I2C_LCD_ADDR, (uint8_t*)data, len, 1000);
...
{
  HAL_I2C_Master_Transmit(&LCD_I2C_HANDLER, (uint16_t)I2C_LCD_ADDR, (uint8_t*)data, len, 1000);
}
